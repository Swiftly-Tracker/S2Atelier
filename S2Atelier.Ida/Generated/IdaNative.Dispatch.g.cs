...
{
    public static readonly IdaSdkVersion[] GeneratedVersions = [IdaSdkVersion.V92, IdaSdkVersion.V93, IdaSdkVersion.V94];
    ...
    public static void BindAll(nint idaHandle, nint idalibHandle, IdaSdkVersion version)
    {
        switch (version)
        {
            ...
            case IdaSdkVersion.V94: IdaNativeBinder_V94.BindAll(idaHandle, idalibHandle); break;
            default:
